...
const content = {
    ...
    aboutHCDPCText: "Health Connections Direct Primary Care, located in the heart of Florence, KY, is your go-to healthcare solution. Since opening in 2017, we've been committed to providing quality care without barriers. Whether you need routine check-ups, basic lab tests, or have unique medical needs, we are here for you. Dr. Villacís's bilingual abilities in English and Spanish ensure that language is never a barrier to your care. Come experience healthcare the way it should be, at Health Connections DPC.",
    services: "Services",
